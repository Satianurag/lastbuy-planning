...
Measure a pilot using matched historical cases: baseline proposed commitment; planner-accepted revised commitment; subsequent receipts/credits; planning labor; service availability; forecast calibration; data remediation cost. Finance signs off the counterfactual. Do not double count a lower purchase commitment as both principal savings and an annual carrying-cost benefit.

...
The [Microsoft Level 3 description](https://www.microsoft.com/en-us/events/local-events/microsoft-agent-a-thon) emphasizes secure enterprise workflows, orchestration and moving agents toward production. The [official rubric](https://founderz.com/agentathon-terms/) gives Innovation, Usability and Impact 30 points each, with Innovation considered first in a tie. Neither source awards a separate score for number of Azure services, agent count or the most expensive model.

The authenticated [Architect final activity](https://learn.founderz.com/lesson/final-activity-design-and-deliver-a-multi-agent-solution/294477ca-84d6-4c42-b258-b56fa24a331b) asks for at least two distinct agents, source/tool responsibilities, information flow and a rationale for using multiple agents. It also asks for an observability/evaluation/governance plan and a deployable, improvable workflow. This is evidence of expected architectural reasoning; it does not require an already completed customer rollout.

The current [Microsoft orchestration guidance](https://learn.microsoft.com/en-us/azure/architecture/ai-ml/guide/ai-agent-design-patterns) says to justify multi-agent complexity. The [hosted-agent evaluation guidance](https://learn.microsoft.com/en-us/azure/foundry/observability/quickstarts/quickstart-evaluate-hosted-agent) treats evaluation as a baseline and release-threshold mechanism. These support a measured, bounded architecture. They do not establish hidden contest preferences.

## The entry to build and present

| Dimension | LastBuy evidence to prioritize | What would weaken it |
|---|---|---|

...
- Policy requires distinct engineering, service, finance and procurement approvers on one plan version, with current role/amount authority checked before export. Only a planner is provisioned as a real cloud user; unresolved review findings block approval.
